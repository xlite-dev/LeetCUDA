...
def fig_20_8():
  ...
  text(30, 42, 1080, 20, "A 的每个坐标位放一份 B 的拷贝：块偏移 = A 的求值结果 * size(B)，块内排布即 B", fs=12.5, fc="#48586a")
  # 左上 layoutA
  ...
  text(GX, GY + 4 * GH + 62, 460, 20, "块序 = A 的值序（row-major 扫描）：左上 -&gt; 右上 -&gt; 左下 -&gt; 右下", fs=12.5, fc="#48586a")
  # 右侧算式
