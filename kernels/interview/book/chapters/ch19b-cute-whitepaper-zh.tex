...
铺瓦（tiling）与求逆（inversion）——支持复杂的布局操作、推导、验证与静态分析。
...
表达现代专用张量指令所需的铺瓦与分块（partitioning）模式。
...
\input{chapters/wp/wp0.tex}
\input{chapters/wp/wp1.tex}
\input{chapters/wp/wp2.tex}
\input{chapters/wp/wp3.tex}
\input{chapters/wp/wp4.tex}
\input{chapters/wp/wp5.tex}
\input{chapters/wp/wp6.tex}
\input{chapters/wp/wp7.tex}
