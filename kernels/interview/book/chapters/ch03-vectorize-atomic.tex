...
\caption{coalescing 与非合并访存对比（fp32，每格 4B，一个 sector 8 格 32B）：coalesced 一条 指令落 4 个 sector 有效率 100\%；stride=2 落 8 个、50\%；大 stride 每线程各占一个 sector、仅 3\%——事务粒度是 32B sector，无用字节照样从 HBM 搬上来。}
\label{fig:3-1}
\end{figure}
