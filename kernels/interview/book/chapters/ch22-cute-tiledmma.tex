...
ffpa\_attn.cuh~L31--79——\texttt{FFPAAttn\allowbreak{}Split\allowbreak{}DCu\allowbreak{}Te\allowbreak{}Traits} 的完整类型推导，
...
\begin{itemize}
  \item \textbf{注释里的线程数要带语境读}。traits 上方的「128 producer
        ...
        是 128 线程（L83--86 注释）。实测 \texttt{size\allowbreak{}(Tiled\allowbreak{}Mma\allowbreak{}QK)}
