...
\begin{tikzpicture}[font=\tiny, x=0.016cm, y=-0.016cm]
  ...
  \foreach \rr/\wr in {0/{warp 0: rows [0, 16)}, 1/{warp 1: rows [16, 32)},
    ...
    \node[draw=gray!60, fill=gray!12, minimum width=1.92cm, minimum height=0.384cm,
...
\begin{tikzpicture}[font=\tiny, x=0.015cm, y=-0.015cm]
  ...
  \foreach \mm/\cy in {0/132, 1/178, 7/250, 8/296, 15/376}{
    ...
    \foreach \cc in {0,...,7}{
      ...
      \ifcase\grp
        \node[draw=tkRed!60, fill=tkFillRed, text=tkRed, minimum width=0.66cm,
              minimum height=0.66cm, inner sep=0pt] at ({172+46*\cc},\cy) {T\tn};
      \or
        \node[draw=tkBlue!60, fill=tkFillBlue, text=tkBlue, minimum width=0.66cm,
              minimum height=0.66cm, inner sep=0pt] at ({172+46*\cc},\cy) {T\tn};
      \or
        \node[draw=tkGreen!60, fill=tkFillGreen, text=tkGreen, minimum width=0.66cm,
              minimum height=0.66cm, inner sep=0pt] at ({172+46*\cc},\cy) {T\tn};
      \or
        \node[draw=tkOrange!70, fill=tkFillOrange, text=tkOrange!80!black,
              minimum width=0.66cm, minimum height=0.66cm, inner sep=0pt]
          at ({172+46*\cc},\cy) {T\tn};
      \or
        \node[draw=tkPurple!60, fill=tkFillPurple, text=tkPurple, minimum width=0.66cm,
              minimum height=0.66cm, inner sep=0pt] at ({172+46*\cc},\cy) {T\tn};
      \or
        \node[draw=gray!50, fill=gray!10, minimum width=0.66cm, minimum height=0.66cm,
              inner sep=0pt] at ({172+46*\cc},\cy) {T\tn};
      \or
        \node[draw=gray!50, fill=gray!22, minimum width=0.66cm, minimum height=0.66cm,
              inner sep=0pt] at ({172+46*\cc},\cy) {T\tn};
      \else
        \node[draw=gray!50, fill=gray!34, minimum width=0.66cm, minimum height=0.66cm,
              inner sep=0pt] at ({172+46*\cc},\cy) {T\tn};
      \fi
    }
  }
