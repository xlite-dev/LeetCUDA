...
表中为 min-of-30 的成对同轮数据（kernel 与 cuDNN 同一轮测量，时钟态一致）。
2026-09-22 的独立复测给出波动带：dense 主场景三组复测分别
238.4/230.7、230.0/230.5、230.3（CLI bench 与 bench\_pd 两种脚本），
$N{=}16384$ 为 239.2/230.9——单点绝对值跨 run 波动 $\pm2\sim3\%$
