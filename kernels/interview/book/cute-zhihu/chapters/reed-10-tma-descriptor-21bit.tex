...
\begin{center}\small 作者：reed（知乎 @reed-84-49，专栏「CUDA高性能编程」）\quad 原文：\url{https://zhuanlan.zhihu.com/p/2037200219700449995}\quad 抓取：2026-09-20\end{center}
...
\paragraph{TMA Descriptor 的完整二进制布局}
...
\paragraph{Control Word 的 bitfield 布局}
...
\paragraph{方法二：在 \texttt{tensormap.replace}[2] 修改 shape 时联动处理 bit21}
