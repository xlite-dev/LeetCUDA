...
\begin{center}\small 作者：reed（知乎 @reed-84-49，专栏「CUDA高性能编程」）\quad 原文：\url{https://zhuanlan.zhihu.com/p/667521327}\end{center}
...
\section{TiledMMA：主机端选择指令，设备端将分块划分到线程}
