...
% 压缩章标题前后距（默认 50/40pt），减少 20 篇文章式章节的章首/章末空白
\ctexset{chapter/beforeskip=6pt, chapter/afterskip=16pt}
...
\input{chapters/reed-01-layout.tex}
\input{chapters/reed-02-layout-algebra-geometry.tex}
\input{chapters/reed-03-tensor.tex}
\input{chapters/reed-04-copy-abstract.tex}
\input{chapters/reed-05-mma-abstract.tex}
\input{chapters/reed-06-swizzle.tex}
\input{chapters/reed-07-hopper-intro.tex}
\input{chapters/reed-08-hopper-mbarrier.tex}
\input{chapters/reed-09-hopper-tma.tex}
\input{chapters/reed-10-tma-descriptor-21bit.tex}
\input{chapters/reed-11-simple-gemm.tex}
...
\input{chapters/zhuxi-01-tiled-copy.tex}
\input{chapters/zhuxi-02-tiled-mma.tex}
\input{chapters/zhuxi-03-compose-inverse.tex}
\input{chapters/zhuxi-04-product-divide.tex}
\input{chapters/zhuxi-05-tma-copy.tex}
\input{chapters/zhuxi-06-permmnk.tex}
\input{chapters/zhuxi-07-async-pipeline.tex}
