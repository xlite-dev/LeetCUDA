...
static void __device_stub__Z21hgemm_wgmma_stages_tnILi64ELi128ELi16ELi128ELi128ELi64ELi256ELi3ELb0EEviiiP6__halfPK14CUtensorMap_stS4_(int, int, int, half *, const CUtensorMap *__restrict__, const CUtensorMap *__restrict__);
...
# 1 "notes-v2.compute_90a.cudafe1.stub.c"
...
static void __device_stub__Z21hgemm_wgmma_stages_tnILi64ELi128ELi16ELi128ELi128ELi64ELi256ELi3ELb0EEviiiP6__halfPK14CUtensorMap_stS4_( int __par0,  int __par1,  int __par2,  half *__par3,  const CUtensorMap *__restrict__ __par4,  const CUtensorMap *__restrict__ __par5) {  const CUtensorMap *__T69;
 const CUtensorMap *__T70;
__cudaLaunchPrologue(6); __cudaSetupArgSimple(__par0, 0UL); __cudaSetupArgSimple(__par1, 4UL); __cudaSetupArgSimple(__par2, 8UL); __cudaSetupArgSimple(__par3, 16UL); __T69 = __par4; __cudaSetupArgSimple(__T69, 24UL); __T70 = __par5; __cudaSetupArgSimple(__T70, 32UL); __cudaLaunch(((char *)((void ( *)(int, int, int, half *, const CUtensorMap *__restrict__, const CUtensorMap *__restrict__))hgemm_wgmma_stages_tn<(int)64, (int)128, (int)16, (int)128, (int)128, (int)64, (int)256, (int)3, (bool)0> )), 0U); }
template<> __specialization_static void __wrapper__device_stub_hgemm_wgmma_stages_tn<64,128,16,128,128,64,256,3,false>( int &__cuda_0,int &__cuda_1,int &__cuda_2,::half *&__cuda_3,const ::CUtensorMap *__restrict__ &__cuda_4,const ::CUtensorMap *__restrict__ &__cuda_5){__device_stub__Z21hgemm_wgmma_stages_tnILi64ELi128ELi16ELi128ELi128ELi64ELi256ELi3ELb0EEviiiP6__halfPK14CUtensorMap_stS4_( (int &)__cuda_0,(int &)__cuda_1,(int &)__cuda_2,(::half *&)__cuda_3,(const ::CUtensorMap *&)__cuda_4,(const ::CUtensorMap *&)__cuda_5);}
...
static void __nv_cudaEntityRegisterCallback( void **__T467) {  __nv_dummy_param_ref(__T467); __nv_save_fatbinhandle_for_managed_rt(__T467); __cudaRegisterEntry(__T467, ((void ( *)(half *, half *, half *, half *, int, int))flash_attn_mma_stages_split_q<(int)64, (int)16, (int)8, (int)16, (int)4, (int)1, (int)4, (int)1, (int)1, (int)8, (int)1, (int)8, (int)2, (int)8> ), _Z29flash_attn_mma_stages_split_qILi64ELi16ELi8ELi16ELi4ELi1ELi4ELi1ELi1ELi8ELi1ELi8ELi2ELi8EEvP6__halfS1_S1_S1_ii, 128); __cudaRegisterEntry(__T467, ((void ( *)(int, int, int, half *, const CUtensorMap *__restrict__, const CUtensorMap *__restrict__))hgemm_wgmma_stages_tn<(int)64, (int)128, (int)16, (int)128, (int)128, (int)64, (int)256, (int)3, (bool)0> ), _Z21hgemm_wgmma_stages_tnILi64ELi128ELi16ELi128ELi128ELi64ELi256ELi3ELb0EEviiiP6__halfPK14CUtensorMap_stS4_, 256); __cudaRegisterEntry(__T467, ((void ( *)(half *, half *, half *, int, int, int))hgemm_mma_stages_tn<(int)16, (int)8, (int)16, (int)2, (int)4, (int)4, (int)4, (int)3, (bool)0> ), _Z19hgemm_mma_stages_tnILi16ELi8ELi16ELi2ELi4ELi4ELi4ELi3ELb0EEvP6__halfS1_S1_iii, 256); __cudaRegisterEntry(__T467, ((void ( *)(float *, float *, float *, int, int))sgemv_k16<(int)2> ), _Z9sgemv_k16ILi2EEvPfS0_S0_ii, (-1)); __cudaRegisterEntry(__T467, ((void ( *)(float *, float *, float, float, int, int))layer_norm_vec4<(int)32> ), _Z15layer_norm_vec4ILi32EEvPfS0_ffii, (-1)); __cudaRegisterEntry(__T467, ((void ( *)(float *, float *, float, float, int, int))layer_norm<(int)128> ), _Z10layer_normILi128EEvPfS0_ffii, (-1)); __cudaRegisterEntry(__T467, ((void ( *)(float *, float *, float, int, int))rms_norm_vec4<(int)32> ), _Z13rms_norm_vec4ILi32EEvPfS0_fii, (-1)); __cudaRegisterEntry(__T467, ((void ( *)(float *, float *, float, int, int))rms_norm<(int)128> ), _Z8rms_normILi128EEvPfS0_fii, (-1)); __cudaRegisterEntry(__T467, ((void ( *)(float *, float *, int))softmax_per_token<(int)256> ), _Z17softmax_per_tokenILi256EEvPfS0_i, (-1)); __cudaRegisterEntry(__T467, ((void ( *)(float *, float *, int))safe_softmax_per_token<(int)256> ), _Z22safe_softmax_per_tokenILi256EEvPfS0_i, (-1)); __cudaRegisterEntry(__T467, ((void ( *)(const float *, float *, int))online_safe_softmax_per_token<(int)256> ), _Z29online_safe_softmax_per_tokenILi256EEvPKfPfi, (-1)); __cudaRegisterEntry(__T467, ((void ( *)(float *, float *, float *, int))dot_vec4<(int)32> ), _Z8dot_vec4ILi32EEvPfS0_S0_i, (-1)); __cudaRegisterEntry(__T467, ((void ( *)(float *, float *, float *, int))dot<(int)128> ), _Z3dotILi128EEvPfS0_S0_i, (-1)); __cudaRegisterEntry(__T467, ((void ( *)(float *, float *, int))block_reduce_all<(int)128> ), _Z16block_reduce_allILi128EEvPfS0_i, (-1)); __cudaRegisterEntry(__T467, ((void ( *)(float *, float *, float *, int, int, int))sgemm_vec4), _Z10sgemm_vec4PfS_S_iii, (-1)); __cudaRegisterEntry(__T467, ((void ( *)(float *, float *, float *, int, int, int))sgemm), _Z5sgemmPfS_S_iii, (-1)); __cudaRegisterEntry(__T467, ((void ( *)(float *, float *, float *, int, int))sgemv_k128), _Z10sgemv_k128PfS_S_ii, (-1)); __cudaRegisterEntry(__T467, ((void ( *)(float *, float *, float *, int, int))sgemv_k32), _Z9sgemv_k32PfS_S_ii, (-1)); __cudaRegisterEntry(__T467, ((void ( *)(float *, float *, const int, const int))mat_transpose_padded), _Z20mat_transpose_paddedPfS_ii, (-1)); __cudaRegisterEntry(__T467, ((void ( *)(float *, float *, const int, const int))mat_transpose), _Z13mat_transposePfS_ii, (-1)); __cudaRegisterEntry(__T467, ((void ( *)(float *, float *, int, int))rope), _Z4ropePfS_ii, (-1)); __cudaRegisterEntry(__T467, ((void ( *)(int *, int *, int))histogram), _Z9histogramPiS_i, (-1)); __cudaRegisterEntry(__T467, ((void ( *)(float *, float *, float *, int))elementwise_add_vec4), _Z20elementwise_add_vec4PfS_S_i, (-1)); __cudaRegisterEntry(__T467, ((void ( *)(float *, float *, float *, int))elementwise_add), _Z15elementwise_addPfS_S_i, (-1)); __cudaRegisterEntry(__T467, ((void ( *)(float *, float *, int))relu_vec4), _Z9relu_vec4PfS_i, (-1)); __cudaRegisterEntry(__T467, ((void ( *)(float *, float *, int))relu), _Z4reluPfS_i, (-1)); }
