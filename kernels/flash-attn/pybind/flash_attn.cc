...
void flexiable_flash_attn_mma_stages(torch::Tensor Q, torch::Tensor K, torch::Tensor V, torch::Tensor O, int stages);
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  TORCH_BINDING_COMMON_EXTENSION(flexiable_flash_attn_mma_stages)
}
