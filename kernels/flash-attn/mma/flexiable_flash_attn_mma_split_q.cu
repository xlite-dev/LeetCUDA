...
flexiable_flash_attn_mma_stages_split_q_kernel(half* Q, 
                                               half* K, 
                                               half* V, 
                                               half* O, 
                                               int QKV_seqlen) {
  ...
  __shared__ float block_row_max_new_smem[Br][kMmaTileSeqLenK]; // [64][1]
  __shared__ float block_row_sum_new_smem[Br][kMmaTileSeqLenK]; // [64][1]
...
void launch_flexiable_flash_attn_mma_stages_split_q(
  ...
  cudaFuncSetAttribute(
    flexiable_flash_attn_mma_stages_split_q_kernel<
      kHeadDim, 
      kMmaAtomM, 
      kMmaAtomN, 
      kMmaAtomK, 
...
void flexiable_flash_attn_mma_stages_split_q(torch::Tensor Q, 
                                             torch::Tensor K, 
                                             torch::Tensor V, 
                                             torch::Tensor O, 
                                             int stages) {
  ...
  if (stages == 2) {
    ...
    {
    case 64:
      launch_flexiable_flash_attn_mma_stages_split_q<64,  2>(Q, K, V, O);
      break;
    case 96:
      launch_flexiable_flash_attn_mma_stages_split_q<96,  2>(Q, K, V, O);
      break;
    case 128:
      launch_flexiable_flash_attn_mma_stages_split_q<128, 2>(Q, K, V, O);
      break;
    default:
    ...
    {
    case 64:
      launch_flexiable_flash_attn_mma_stages_split_q<64,  1>(Q, K, V, O);
      break;
    case 96:
      launch_flexiable_flash_attn_mma_stages_split_q<96,  1>(Q, K, V, O);
      break;
    case 128:
      launch_flexiable_flash_attn_mma_stages_split_q<128, 1>(Q, K, V, O);
      break;
    default:
      throw std::runtime_error("headdim not support!");
      break;
