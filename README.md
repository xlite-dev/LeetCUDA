...
## News 🔥🔥
- [2025-01-08]: [📚Fully QKV Fine-grained Tiling](#mma-tiling-qkv) has been refactored into the 🤖[cuffpa-py](https://github.com/DefTruth/cuffpa-py) library: 📚FFPA - Yet another Faster Flash Prefill Attention with O(1)🎉GPU SRAM complexity for headdim > 256, 1.5x~2x🎉faster than SDPA EA. (WIP 👀~)
- [2024-12-02]: HGEMM MMA kernels has been refactored into the 🤖[hgemm-tensorcores-mma](https://github.com/DefTruth/hgemm-tensorcores-mma) library: ⚡️Write HGEMM from scratch using Tensor Cores with WMMA, MMA PTX and CuTe API (Write for Fun 👀~)
