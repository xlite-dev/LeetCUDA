...
**rr**: means reduce registers usage; **f32**: means MMA accumulate with FP32 dtype, otherwise, FP16. Softmax acc is always be FP32; **swizzle**: now, only means smem swizzle for MMA.
